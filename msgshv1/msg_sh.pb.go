...
type MsgSHv1 struct {
	...
	// 读取模拟量
	Afn0CP0F11 *Afn04_P0_F26 `protobuf:"bytes,502,opt,name=afn0c_p0_f11,json=afn0cP0F11,proto3" json:"afn0c_p0_f11,omitempty"`
	// 读取遥信量
...
func (m *MsgSHv1) GetAfn0CP0F11() *Afn04_P0_F26 {
	if m != nil {
		return m.Afn0CP0F11
	}
	return nil
...
type Afn04_P0_F4 struct {
	// 控制箱编号
	CboxNumber int32 `protobuf:"varint,1,opt,name=cbox_number,json=cboxNumber,proto3" json:"cbox_number,omitempty"`
	// 终端地址
	TmlPhyid int32 `protobuf:"varint,2,opt,name=tml_phyid,json=tmlPhyid,proto3" json:"tml_phyid,omitempty"`
	// 经度
...
func (m *Afn04_P0_F4) GetCboxNumber() int32 {
	if m != nil {
		return m.CboxNumber
	}
	return 0
...
func (m *Afn04_P0_F4) GetTmlPhyid() int32 {
	if m != nil {
		return m.TmlPhyid
	}
	return 0
...
type Afn04_P0_F9 struct {
	// 起始日期,unix时间戳
	DtStart int32 `protobuf:"varint,1,opt,name=dt_start,json=dtStart,proto3" json:"dt_start,omitempty"`
	// 数据天数，2月始终按29天算
...
func (m *Afn04_P0_F9) GetDtStart() int32 {
	if m != nil {
		return m.DtStart
	}
	return 0
...
type Afn04_P0_F25 struct {
	// 回路设置
	LoopInfo []*Afn04_P0_F25_Loop_Info `protobuf:"bytes,1,rep,name=loop_info,json=loopInfo,proto3" json:"loop_info,omitempty"`
}
...
type Afn04_P0_F26 struct {
	...
	LoopData  []*Afn04_P0_F26_Loop_Data `protobuf:"bytes,2,rep,name=loop_data,json=loopData,proto3" json:"loop_data,omitempty"`
}
...
type Afn0C_P0_F12 struct {
	// 起始回路序号
	IdxStart   int32                       `protobuf:"varint,1,opt,name=idx_start,json=idxStart,proto3" json:"idx_start,omitempty"`
	LoopStatus []*Afn0C_P0_F12_Loop_Status `protobuf:"bytes,2,rep,name=loop_status,json=loopStatus,proto3" json:"loop_status,omitempty"`
}
...
func (m *Afn0C_P0_F12) GetIdxStart() int32 {
	if m != nil {
		return m.IdxStart
	}
	return 0
...
func (m *Afn0C_P0_F12_Loop_Status) GetIndex() int32 {
	if m != nil {
		return m.Index
	}
	return 0
...
type Afn0E_P0_F1 struct {
	...
	// 以下为上行填充字段
	// 当前读到的位置，重要事件
	Ec1Now int32 `protobuf:"varint,3,opt,name=ec1_now,json=ec1Now,proto3" json:"ec1_now,omitempty"`
	// 当前读到的位置，一般事件
	Ec2Now int32 `protobuf:"varint,4,opt,name=ec2_now,json=ec2Now,proto3" json:"ec2_now,omitempty"`
	// 事件信息
...
func (m *Afn0E_P0_F1) GetEc1Now() int32 {
	if m != nil {
		return m.Ec1Now
	}
	return 0
...
func (m *Afn0E_P0_F1) GetEc2Now() int32 {
	if m != nil {
		return m.Ec2Now
	}
	return 0
...
func (*Afn0E_P0_F1_Erc01_Data) Descriptor() ([]byte, []int) {
	return fileDescriptor_26356b1ce2c0395d, []int{14, 1}
}
...
func (*Afn0E_P0_F1_Erc06_Data) Descriptor() ([]byte, []int) {
	return fileDescriptor_26356b1ce2c0395d, []int{14, 2}
}
...
func (*Afn0E_P0_F1_Erc14_Data) Descriptor() ([]byte, []int) {
	return fileDescriptor_26356b1ce2c0395d, []int{14, 3}
}
...
var fileDescriptor_26356b1ce2c0395d = []byte{
	...
	,
}
...
func (m *Afn04_P0_F9) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.DtStart != 0 {
		i = encodeVarintMsgSh(dAtA, i, uint64(m.DtStart))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Afn0C_P0_F12) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.IdxStart != 0 {
		i = encodeVarintMsgSh(dAtA, i, uint64(m.IdxStart))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Afn0E_P0_F1) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Ec2Now != 0 {
		i = encodeVarintMsgSh(dAtA, i, uint64(m.Ec2Now))
		i--
		dAtA[i] = 0x20
	}
	if m.Ec1Now != 0 {
		i = encodeVarintMsgSh(dAtA, i, uint64(m.Ec1Now))
		i--
		dAtA[i] = 0x18
	}
	if m.Pn != 0 {
...
func (m *Afn0C_P0_F12) Size() (n int) {
	...
	_ = l
	if m.IdxStart != 0 {
		n += 1 + sovMsgSh(uint64(m.IdxStart))
	}
	if len(m.LoopStatus) > 0 {
...
func (m *Afn0E_P0_F1) Size() (n int) {
	...
	if m.Ec1Now != 0 {
		n += 1 + sovMsgSh(uint64(m.Ec1Now))
	}
	if m.Ec2Now != 0 {
		n += 1 + sovMsgSh(uint64(m.Ec2Now))
	}
	if len(m.EventsData) > 0 {
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CboxNumber |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *Afn0C_P0_F12) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IdxStart", wireType)
			}
			m.IdxStart = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *Afn0E_P0_F1) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Ec1Now", wireType)
			}
			m.Ec1Now = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Ec2Now", wireType)
			}
			m.Ec2Now = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
