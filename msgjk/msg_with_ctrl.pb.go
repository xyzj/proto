...
type MsgWithCtrl struct {
	...
	// 国标
	// 应答确认/否认
	WlstOpen_0000 *WlstOpen_0000 `protobuf:"bytes,3001,opt,name=wlst_open_0000,json=wlstOpen0000,proto3" json:"wlst_open_0000,omitempty"`
	// 复位下行
	WlstOpen_0101 *WlstOpen_0101 `protobuf:"bytes,3002,opt,name=wlst_open_0101,json=wlstOpen0101,proto3" json:"wlst_open_0101,omitempty"`
	// 登录/心跳上行
	WlstOpen_0902 *WlstOpen_0902 `protobuf:"bytes,3003,opt,name=wlst_open_0902,json=wlstOpen0902,proto3" json:"wlst_open_0902,omitempty"`
}
...
func (m *MsgWithCtrl) GetWlstOpen_0000() *WlstOpen_0000 {
	if m != nil {
		return m.WlstOpen_0000
	}
	return nil
}

func (m *MsgWithCtrl) GetWlstOpen_0101() *WlstOpen_0101 {
	if m != nil {
		return m.WlstOpen_0101
	}
	return nil
}

func (m *MsgWithCtrl) GetWlstOpen_0902() *WlstOpen_0902 {
	if m != nil {
		return m.WlstOpen_0902
	}
	return nil
}
...
var fileDescriptor_17a284b5b5297b67 = []byte{
	...
	,
}
...
func (m *MsgWithCtrl) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.WlstOpen_0902 != nil {
		{
			size, err := m.WlstOpen_0902.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.WlstOpen_0101 != nil {
		{
			size, err := m.WlstOpen_0101.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.WlstOpen_0000 != nil {
		{
			size, err := m.WlstOpen_0000.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *MsgWithCtrl) Size() (n int) {
	...
	if m.WlstOpen_0000 != nil {
		l = m.WlstOpen_0000.Size()
		n += 3 + l + sovMsgWithCtrl(uint64(l))
	}
	if m.WlstOpen_0101 != nil {
		l = m.WlstOpen_0101.Size()
		n += 3 + l + sovMsgWithCtrl(uint64(l))
	}
	if m.WlstOpen_0902 != nil {
		l = m.WlstOpen_0902.Size()
		n += 3 + l + sovMsgWithCtrl(uint64(l))
	}
	return n
}
...
func (m *MsgWithCtrl) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3001:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field WlstOpen_0000", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.WlstOpen_0000 == nil {
				m.WlstOpen_0000 = &WlstOpen_0000{}
			}
			if err := m.WlstOpen_0000.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3002:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field WlstOpen_0101", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.WlstOpen_0101 == nil {
				m.WlstOpen_0101 = &WlstOpen_0101{}
			}
			if err := m.WlstOpen_0101.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3003:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field WlstOpen_0902", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.WlstOpen_0902 == nil {
				m.WlstOpen_0902 = &WlstOpen_0902{}
			}
			if err := m.WlstOpen_0902.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
