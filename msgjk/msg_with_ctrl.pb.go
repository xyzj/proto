...
type MsgWithCtrl struct {
	...
	// 国标
	// 应答确认/否认
	WlstOpen_0000 *Wlst_Open_0000 `protobuf:"bytes,3001,opt,name=wlst_open_0000,json=wlstOpen0000,proto3" json:"wlst_open_0000,omitempty"`
	// 复位下行
	WlstOpen_0101 *Wlst_Open_0101 `protobuf:"bytes,3002,opt,name=wlst_open_0101,json=wlstOpen0101,proto3" json:"wlst_open_0101,omitempty"`
	// 登录/心跳上行
	WlstOpen_0902 *Wlst_Open_0902 `protobuf:"bytes,3003,opt,name=wlst_open_0902,json=wlstOpen0902,proto3" json:"wlst_open_0902,omitempty"`
}
...
func (m *MsgWithCtrl) GetWlstOpen_0000() *Wlst_Open_0000 {
	if m != nil {
...
func (m *MsgWithCtrl) GetWlstOpen_0101() *Wlst_Open_0101 {
	if m != nil {
...
func (m *MsgWithCtrl) GetWlstOpen_0902() *Wlst_Open_0902 {
	if m != nil {
...
var fileDescriptor_17a284b5b5297b67 = []byte{
	...
	,
}
...
func (m *MsgWithCtrl) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3001:
			...
			if m.WlstOpen_0000 == nil {
				m.WlstOpen_0000 = &Wlst_Open_0000{}
			}
		...
		case 3002:
			...
			if m.WlstOpen_0101 == nil {
				m.WlstOpen_0101 = &Wlst_Open_0101{}
			}
		...
		case 3003:
			...
			if m.WlstOpen_0902 == nil {
				m.WlstOpen_0902 = &Wlst_Open_0902{}
			}
